...
//			netScene.x = 10;
			...
			tf.text = '说明：左边为本地场景，右边为延迟后的某玩家看到的网络场景\n方向键控制方向移动';
			addChild(tf);
			...
			var updateMethods:Array = [{label:'状态更新', value:0}, {label:'航位预测', value:1}];
			...
			var smoothMethods:Array = [{label:'无', value:0}, {label:'指数平滑', value:1}, {label:'立方平滑', value:2}];
